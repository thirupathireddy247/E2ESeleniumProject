 ...
 * public class ExtentReporterNG implements IReporter { private ExtentReporter
 * extent;
 * 
 * public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites,
 * String outputDirectory) { extent = new ExtentReporter(outputDirectory +
 * File.separator + "ExtentReportsTestNG.html", true);
 * 
